...
class FourthPage extends StatefulWidget {
  ...
  @override
  State<FourthPage> createState() => _HomeState();
}

class _HomeState extends State<FourthPage> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                onPressed: () {
                  double sum = int.parse(box) / int.parse(numController.text);
